...
class DriverViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    /* UITableViewDelegate, UITableViewDataSource указывают, что DriversViewController
     будет источником данных для TableView */
    ...
    /* Инициализация нового ViewController при нажатии на ячейку таблицы
     и передача данных из массива drivers в новый ViewController */
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let storyboard = UIStoryboard(name: "Main", bundle: .main)
        /* При прописывании ViewController без "as!" ему присваивается базовый класс
         UIViewController. Для получения возможности переноса данных нужно дописать
         дополнение с "as!". */
